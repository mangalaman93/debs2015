...
#sleep 1
#java $DEBSVM_ARGS -Dlog-file-name=$LOG_DIR/$TS/Worker5.log -jar lib/seep-system-0.0.1-SNAPSHOT-jar-with-dependencies.jar Worker 3505 > $LOG_DIR/$TS/Worker5.out 2>&1 &
